...
export const MAX_SLACK_BLOCK_TEXT_LENGTH = 3000; // Increased limit for rich_text blocks which support full-width
export const MAX_SLACK_BLOCK_CODE_LENGTH = 4000; // Increased limit for code blocks in rich_text format
